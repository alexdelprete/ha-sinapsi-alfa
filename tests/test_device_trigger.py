...
class TestTriggerConstants:
    """Tests for trigger constants."""

    def test_trigger_types_values(self) -> None:
...
class TestAsyncGetTriggers:
    ...
    @pytest.mark.asyncio
    async def test_get_triggers_device_not_found(self, hass: HomeAssistant) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_triggers_device_wrong_domain(self, hass: HomeAssistant) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_triggers_success(self, hass: HomeAssistant) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_triggers_all_types_included(self, hass: HomeAssistant) -> None:
...
class TestAsyncAttachTrigger:
    ...
    @pytest.mark.asyncio
    async def test_attach_trigger_calls_event_trigger(self, hass: HomeAssistant) -> None:
