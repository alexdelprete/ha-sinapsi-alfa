...
Special thanks to [@Miraitowa-la](https://github.com/Miraitowa-la), the ModbusLink developer, who implemented
our feature request ([ModbusLink#5](https://github.com/Miraitowa-la/ModbusLink/issues/5)) for a `flush()` method
and auto-drain mechanism in ModbusLink 1.4.2. The release even included a Home Assistant integration code example
