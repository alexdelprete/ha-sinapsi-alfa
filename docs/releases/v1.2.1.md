...
**Type:** Stable Release - Feature Alignment with ha-4noks-elios4you v1.1.0

## Highlights

This release aligns ha-sinapsi-alfa with
[ha-4noks-elios4you v1.1.0](https://github.com/alexdelprete/ha-4noks-elios4you/releases/tag/v1.1.0),
bringing advanced device automation features and configurable repair notifications.
...
- Improved field ordering matching ha-4noks-elios4you
...
- `__init__.py` - v2→v3 migration, device_id storage
