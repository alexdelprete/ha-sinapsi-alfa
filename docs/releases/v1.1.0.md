...
Added a new `timeout` configuration parameter that allows users to adjust the connection timeout for high-latency
network scenarios:
...
The default timeout has been increased from 3-5 seconds to **10 seconds** to better accommodate typical network
conditions without requiring manual configuration.
...
Thanks to Lorenzo Canale ([@lorenzocanalelc](https://github.com/lorenzocanalelc)) for reporting the VPN connection
issue in [#180](https://github.com/alexdelprete/ha-sinapsi-alfa/issues/180).
...
[v1.0.1...v1.1.0](https://github.com/alexdelprete/ha-sinapsi-alfa/compare/v1.0.1...v1.1.0)
