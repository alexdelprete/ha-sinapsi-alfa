...
This is a **major architectural change** that migrates the Modbus communication layer from pymodbus to ModbusLink. This
beta release requires extensive testing before stable release.
...
ModbusLink is currently in **Alpha status** (Development Status 3). This migration prioritizes modern API design over
